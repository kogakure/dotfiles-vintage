...
local LAYOUT_DUAL = {
  ...
  {"HipChat",               nil, DISPLAY_MAIN,     RIGHT_HALF, nil, nil},
...
local LAYOUT_NOTEBOOK = {
  ...
  {"Kalender",              nil, DISPLAY_MAIN, FULLSCREEN, nil, nil},
  {"Mail",                  nil, DISPLAY_MAIN, FULLSCREEN, nil, nil},
  ...
  {"Telegram",              nil, DISPLAY_MAIN, FULLSCREEN, nil, nil},
